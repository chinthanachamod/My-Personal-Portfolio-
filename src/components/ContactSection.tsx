          ...
          <div className="lg:col-span-1">
            ...
            delay: 0.3
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.linkedin.com/in/chinthana-chamod-2a133b323/" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-700'} transition-colors`}>
                  <span className="sr-only">LinkedIn</span>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="https://wa.me/94717500753" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-700'} transition-colors`}>
                ...
                <a href="https://www.instagram.com/chinthana_chamod_bn?igsh=aHh3MnVmcWRtZ2w4" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full ${theme === 'dark' ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-700'} transition-colors`}>
            ...
            <form onSubmit={handleSubmit} className={`p-8 rounded-lg shadow-lg ${theme === 'dark' ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} required className={`w-full px-4 py-3 rounded-lg ${theme === 'dark' ? 'bg-gray-800 border-gray-700 text-white focus:border-blue-500' : 'bg-gray-100 border-gray-300 text-gray-900 focus:border-blue-500'} border focus:ring-2 focus:ring-blue-500/20 outline-none transition-colors`} placeholder="Enter your name" />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium mb-2">
                    Your Email
                  </label>
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} required className={`w-full px-4 py-3 rounded-lg ${theme === 'dark' ? 'bg-gray-800 border-gray-700 text-white focus:border-blue-500' : 'bg-gray-100 border-gray-300 text-gray-900 focus:border-blue-500'} border focus:ring-2 focus:ring-blue-500/20 outline-none transition-colors`} placeholder="example@gmail.com" />
                </div>
              </div>
              <div className="mb-6">
