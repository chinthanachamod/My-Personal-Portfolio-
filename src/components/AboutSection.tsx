        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          duration: 0.8
            ...
            <div className="relative group">
              <div className={`absolute inset-0 transform translate-x-4 translate-y-4 -z-10 ${theme === 'dark' ? 'bg-gradient-to-r from-blue-600 to-purple-600' : 'bg-gradient-to-r from-blue-500 to-purple-500'} transition-all duration-300 group-hover:translate-x-5 group-hover:translate-y-5`}></div>
              <img src="src/assets/My Image.jpg" alt="Profile" className="w-full h-auto object-cover relative z-10 transition-transform duration-300 group-hover:transform group-hover:scale-[1.01]" />
            </div>
          </motion.div>
          <motion.div initial={{
          opacity: 0,
